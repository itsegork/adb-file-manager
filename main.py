...
class InfoWindow:    
    ...
    def _setup_ui(self):
        ...
        github_link.bind("<Button-1>", lambda e: webbrowser.open(f"https://github.com/{Config.GITHUB_REPO}"))
        ...
        license_link.bind("<Button-1>", lambda e: webbrowser.open(f"https://github.com/{Config.GITHUB_REPO}/blob/main/LICENSE"))
...
class ADBFileManager:
    ...
    def _setup_ui(self):
        ...
        ttk.Button(info_frame, text="ℹ️ О программе", 
            command=self._show_info_window).pack(side=tk.RIGHT, padx=5)
